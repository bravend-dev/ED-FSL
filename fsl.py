...
def main(args):
    ...
    if args.beta > 0.0:
        ...
        wsd_train_dl = DataLoader(wsd_train_dl, batch_size=128, shuffle=True, collate_fn=sup_pack)
    ...
    fsl_trainer = MELRTCFSLTrainer(fsl_model, train_dl, dev_dl, test_dl, args, wsd_model, wsd_train_dl)
