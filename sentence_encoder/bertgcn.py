...
class BertGCN(nn.Module):
    def __init__(self, vectors, args):
        ...
        self.bert = AutoModel.from_pretrained(args.bert_pretrained)
    ...
    def forward(self, inputs):
        ...
        bert_output = self.bert(text_bert_indices,
                                     bert_segments_ids,
                                     output_hidden_states=True)

        x = torch.cat(bert_output['hidden_states'][-self.bert_layer:], dim=-1)
