...
# from supervise import WSDModel, SuperviseTrainer
...
def argument_parser():
    ...
    # Training setting
    parser.add_argument('-m', '--model', default='melr', choices=fsl_class.keys())
    ...
    parser.add_argument('--train_way', default=20, type=int)
    parser.add_argument('--train_shot', default=10, type=int)
    parser.add_argument('-n', '--way', default=10, type=int)
    parser.add_argument('-k', '--shot', default=10, type=int)
...
def main(args):
    ...
    train_dl = FSLDataset(TN, TK*2, Q*2,
    ...
    fsl_trainer = MELRTCFSLTrainer(fsl_model, train_dl, dev_dl, test_dl, args)
    print('Do train')
