...
class MELRNetworkNoAttention(FSLBaseModel):
    def __init__(self, encoder, args):
        super(MELRNetworkNoAttention, self).__init__(encoder, args)
        self.dropout = nn.Dropout(args.dropout)
        self.head = ProtoHead()
        self.kl = nn.KLDivLoss()
...
class MELRNetworkNoLoss(FSLBaseModel):
    def __init__(self, encoder, args):
        super(MELRNetworkNoLoss, self).__init__(encoder, args)
        self.dropout = nn.Dropout(args.dropout)
        self.head = ProtoHead()
        self.kl = nn.KLDivLoss()
